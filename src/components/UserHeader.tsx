      ...
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-2xl font-bold animate-fade-in">{user.name || user.login}</h2>
            <h3 className="text-lg text-muted-foreground mb-2 animate-fade-in stagger-1">{user.login}</h3>
            
            {user.bio && <p className="mb-4 animate-fade-in stagger-2">{user.bio}</p>}
